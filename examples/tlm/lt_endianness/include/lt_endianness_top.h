...
/* ---------------------------------------------------------------------------------------
 @file lt_endianness_top.h
 
 @brief lt_endianness_top class header
...
#ifndef __LT_ENDIANNESS_TOP_H__
#define __LT_ENDIANNESS_TOP_H__
...
class lt_endianness_top                             ///< top wrapper module 
: public sc_core::sc_module                         ///< SystemC module base class
{
  public:

  lt_endianness_top                                 ///< constructor
