...
int sc_main(int argc, char *argv[]) {
  ...
  SC_ALLOW_CONCURRENCY(my_parallel_module, sc_core::sc_sync_policy_tlm_quantum) mp("Parallel");
  //SC_ALLOW_CONCURRENCY(my_parallel_module, sc_core::sc_sync_policy_in_sync) mp("Parallel");
