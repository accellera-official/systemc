...
#  include <sysc/packages/boost/detail/lwm_linux.hpp>
...
#  include <sysc/packages/boost/detail/lwm_win32.hpp>
#elif defined(BOOST_LWM_USE_SPINLOCK) && defined(__sgi)
#  include <sysc/packages/boost/detail/lwm_irix.hpp>
#elif defined(BOOST_LWM_USE_SPINLOCK) && defined(__GLIBCPP__)
#  include <sysc/packages/boost/detail/lwm_gcc.hpp>
