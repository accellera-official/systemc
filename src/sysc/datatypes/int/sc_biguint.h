...
public: // "mirror" for sc_signed concatenation support:
    virtual int concat_length(bool* xz_present_p) const 
        { return sc_unsigned_proxy().concat_length(xz_present_p); }
    virtual uint64 concat_get_uint64() const 
        { return sc_unsigned_proxy().concat_get_uint64(); }
    virtual bool concat_get_ctrl( sc_digit* dst_p, int low_i ) const 
        { return sc_unsigned_proxy().concat_get_ctrl(dst_p,low_i); }
    virtual bool concat_get_data( sc_digit* dst_p, int low_i ) const 
        { return sc_unsigned_proxy().concat_get_data(dst_p,low_i); }
    virtual void concat_set(int64 src, int low_i)
        { sc_unsigned_proxy().concat_set(src, low_i);}
