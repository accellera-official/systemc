...
#include "adapter_tlm_1_2.h"                  ///< adpter tlm 1 to 2
#include "adapter_tlm_2_1.h"                  ///< adpter tlm 2 to 1
#include "tlm_1_master.h"                     ///< tlm1 master 
#include "tlm_1_slave_memory.h"               ///< tlm1 slave memory 
...
: public sc_core::sc_module                   ///< module base class
{
  ...
  adapter_tlm_1_2           m_adapter_tlm_1_2;  ///< adapter 1 to 2 
  adapter_tlm_2_1           m_adapter_tlm_2_1;  ///< adapter 2 to 1
 
  tlm_1_master              m_tlm_1_master;     ///< tlm1 master 
  tlm_1_mem_slave           m_tlm_1_mem_slave;  ///< tlm1 memory slave 
