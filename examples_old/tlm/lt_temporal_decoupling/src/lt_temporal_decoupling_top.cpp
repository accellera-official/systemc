...
/* ---------------------------------------------------------------------------------------
 @file lt_temporal_decoupling_top.cpp
 
 @brief LT temporal decoupling SystemC top module
...
/*=============================================================================
  ...
  @brief lt_temporal_decoupling_top constructor
  
  @details
    This routine initialized a lt_temporal_decoupling_top class instance.
    
  @param name module name
  
  @retval none
=============================================================================*/
lt_temporal_decoupling_top::lt_temporal_decoupling_top       
