...
/* ---------------------------------------------------------------------------------------
 @file lt_initiator_temporal_decoupling.h
...
#include "lt_initiator_temporal_decoupling.h"       ///< LT initiator with temporal decoupling

using namespace sc_core;
using namespace std;

const char *filename = "lt_initiator_temporal_decoupling.cpp";
