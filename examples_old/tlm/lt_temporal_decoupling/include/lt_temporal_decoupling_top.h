...
/* ---------------------------------------------------------------------------------------
 @file lt_temporal_decoupling.h
 
 @brief lt_temporal_decoupling class header
...
#ifndef __LT_TEMPORAL_DECOUPLING_TOP_H__
#define __LT_TEMPORAL_DECOUPLING_TOP_H__
...
class lt_temporal_decoupling_top                    ///< top wrapper module 
: public sc_core::sc_module                         ///< SystemC module base class
{
  public:

  lt_temporal_decoupling_top                        ///< constructor
...
#endif /* __LT_TEMPORAL_DECOUPLING_TOP_H__ */
