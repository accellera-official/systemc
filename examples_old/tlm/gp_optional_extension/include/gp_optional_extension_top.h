...
/*=============================================================================
  @file gp_optional_extension_top.h
...
#ifndef __GP_OPTIONAL_EXTENSION_TOP_H__
#define __GP_OPTIONAL_EXTENSION_TOP_H__
...
class gp_optional_extension_top               ///<  top wrapper module 
: public sc_core::sc_module                   ///<  SystemC module base class
{
  public:

  gp_optional_extension_top                   ///<  constructor
...
#endif /* __GP_OPTIONAL_EXTENSION_TOP_H__ */
