...
#ifndef __LT_AT_SWITCH_TOP_H__
#define __LT_AT_SWITCH_TOP_H__

#include "tlm.h"                              ///< TLM header
#include "lt_at_switch_target.h"              ///< at memory target
...
class lt_at_switch_top                        ///<  top wrapper module 
: public sc_core::sc_module                   ///<  SystemC module base class
{
  public:

  lt_at_switch_top                            ///<  constructor
  ...
  lt_at_switch_target      m_switch_target_1;    ///< target 
