...
#include "tlm_1_integration_explicit_slave_top.h"   ///< our header
...
( sc_core::sc_module_name name                ///< module name
  ...
  , m_adapter_tlm_1_2_sync                    ///< adapter 1 to 2
    ("m_adapter_tlm_1_2_sync"
     )

  , m_adapter_tlm_2_1_sync                    ///< adapter 2 to 1 
    ("m_adapter_tlm_2_1_sync"
     )

  , m_tlm_1_master_2                          ///< tlm1 master 
    ("m_tlm_1_master_2"
     )

  , m_tlm_1_slave_memory_explicit             ///< tlm1 memory slave      
    ("m_tlm_1_slave_memory_explicit"  
    )
{
//------------------------------------------------------------------------------
// connect the sockets to the switch
  ...
  m_adapter_tlm_1_2_sync.initiator_socket(m_bus.target_socket[1]);
  ...
  m_bus.initiator_socket[1](m_adapter_tlm_2_1_sync.adapter_socket);

  // bind TLM1 to TLM1-to-TLM2 adapter
  m_tlm_1_master_2.initiator_port(m_adapter_tlm_1_2_sync.tlm_1_export);

  // bind TLM2-to-TLM1 adapter to TLM1 memory 
  m_adapter_tlm_2_1_sync.tlm_1_initiator_port(m_tlm_1_slave_memory_explicit.target_port);
