...
#ifndef __AT_LT_FULL_SYSTEM_TOP_H__
#define __AT_LT_FULL_SYSTEM_TOP_H__
...
class at_lt_full_system_top                   ///<  top wrapper module 
: public sc_core::sc_module                   ///<  SystemC module base class
{
  public:

  at_lt_full_system_top                       ///<  constructor
...
#endif /* __AT_LT_FULL_SYSTEM_TOP_H__ */
