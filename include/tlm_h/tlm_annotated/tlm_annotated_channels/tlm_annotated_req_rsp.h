...
#ifndef __TLM_ANNOTATED_REQ_RSP_H__
#define __TLM_ANNOTATED_REQ_RSP_H__
...
class tlm_annotated_req_rsp_channel : public sc_core::sc_module
{
public:
  // uni-directional slave interface

  sc_core::sc_export< tlm_annotated_get_peek_if< REQ > > get_request_export;
  sc_core::sc_export< tlm_annotated_put_if< RSP > > put_response_export;

  // uni-directional master interface

  sc_core::sc_export< tlm_annotated_put_if< REQ > > put_request_export;
  sc_core::sc_export< tlm_annotated_get_peek_if< RSP > > get_response_export;

  // master / slave interfaces

  sc_core::sc_export< tlm_annotated_master_if< REQ , RSP  > > master_export;
  sc_core::sc_export< tlm_annotated_slave_if< REQ , RSP > > slave_export;
  ...
  tlm_annotated_req_rsp_channel( sc_core::sc_module_name module_name ,
