...
sc_main( int, char*[] )
{
    ...
    for (size_t i = 0; i < 128; i+=4) {
        ( i128[i] , i128[i+1], i128[i+3] , i128[i+2] ) = 0b1101;
        ( u128[i] , u128[i+1], u128[i+3] , u128[i+2] ) = 0b1101;
    }
    ...
    for (size_t i = 0; i < 128; i+=4) {
        ( i128(i+2,i), i128(i+3,i+3) ) = 0b1011;
        ( u128(i+2,i), u128(i+3,i+3) ) = 0b1011;
    }
    ...
    ( i128, u128[3], u128[2], u128(7,7), u128(5,4) ) = 0b11000011110;
