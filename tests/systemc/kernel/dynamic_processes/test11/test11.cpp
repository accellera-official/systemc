...
/*****************************************************************************
  ...
  changes you are making here.
      ...
      Name, Affiliation, Date: Philipp A. Hartmann, Apple Inc.
  Description of Modification: Copied from test01.cpp and move to lambda functions
...
public:
  ...
  void main()
  {
    ...
    SC_FORK
      sc_spawn(&r, [&]{ return round_robin("1", e1, e2, 3); }, "t1"),
      sc_spawn(&r, [&]{ return round_robin("2", e2, e3, 3); }, "t2"),
      sc_spawn(&r, [&]{ return round_robin("3", e3, e4, 3); }, "t3"),
      sc_spawn(&r, [&]{ return round_robin("4", e4, e1, 3); }, "t4")
    SC_JOIN
    ...
    wait( sc_spawn(&r, []{ return test_function(3.14159); }).terminated_event() );
    ...
    sc_process_handle handle1 = sc_spawn( []{ void_function(1.2345); },
                                          "void_function", &ops );
    wait(handle1.terminated_event());

    double d = 9.8765;
    wait( sc_spawn(&r, [&]{ return ref_function(d); }).terminated_event() );
