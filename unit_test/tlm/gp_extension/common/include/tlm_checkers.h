...
#ifndef __TLM_CHECKERS_H__
#define __TLM_CHECKERS_H__
...
public:
    ...
    void write_command_not_supported()    {m_write_command_supported = false;}
    void read_command_not_supported()     {m_read_command_supported = false;}
    void burst_not_supported()            {m_burst_supported = false;}
    void burst_mode_streaming_not_supported() {m_burst_mode_streaming_supported = false;}
    void byte_enable_not_supported()      {m_byte_enable_supported = false;}
...
private:
    ...
    tlm_response_status do_check(tlm::tlm_generic_payload* gp)
    {
        ...
        if(gp->get_data_length() > m_bus_data_size)
        {
