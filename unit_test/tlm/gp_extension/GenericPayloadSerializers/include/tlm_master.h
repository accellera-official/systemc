...
template< class T >
void tlm_master::prepare_arrays(int nbits, T& reg, bool shift) 
{
...
//
template< int W >
void tlm_master::write(unsigned int address, unsigned char *data, bool* be, unsigned int be_length)
{
...
//
template< int W >
void tlm_master::read(unsigned int address, unsigned char *data, bool* be, unsigned int be_length)
{
